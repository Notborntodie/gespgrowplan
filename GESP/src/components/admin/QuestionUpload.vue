  ...
  <div class="content-section">
    ...
    <div class="upload-cards-container">
      ...
      <div class="upload-card elevate-card">
        <div class="card-header" @click="openKnowledgePointDialog">
    ...
    <KnowledgePointDialog
      :visible="showKnowledgePointDialog"
      @close="closeKnowledgePointDialog"
    />
...
import KnowledgePointDialog from './Dialog/KnowledgePointDialog.vue'
...
// 弹窗状态管理
const showKnowledgePointDialog = ref(false)
...
// 打开弹窗方法
function openKnowledgePointDialog() {
  showKnowledgePointDialog.value = true
}
...
function openUploadHistoryDialog() {
  showUploadHistoryDialog.value = true
}

// 关闭弹窗方法
function closeKnowledgePointDialog() {
  showKnowledgePointDialog.value = false
}
...
function closeUploadHistoryDialog() {
